                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <nav className="glass rounded-b-3xl px-5 lg:px-8 h-16 lg:h-32 flex items-center justify-between shadow-xl relative backdrop-blur-md border-x border-b border-white/40">
                        ...
                        <div className="lg:hidden flex items-center gap-2">
                            <a
                                href={gestaoLink}
                                className="flex items-center gap-1.5 px-3 py-2 bg-blue-600 text-white rounded-xl text-[10px] sm:text-xs font-black shadow-lg shadow-blue-600/20 active:scale-95 transition-all"
                            >
                                <LayoutDashboard className="w-3.5 h-3.5 sm:w-4 h-4" />
                                Adm / Prof
                            </a>
                            <a
                                href="https://aluno.edutic.com.br"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-1.5 px-3 py-2 bg-slate-100 text-slate-900 rounded-xl text-[10px] sm:text-xs font-black active:scale-95 transition-all border border-slate-200"
                            >
